...
public class givemoney {
	...
	public givemoney(CommandSender sender, String[] args){
		this.sender = sender;
		this.args = args;
			...
			value = Integer.parseInt(args[1]);
				...
				if(wal != null){
					...
					if(info.hasWallet(Bukkit.getPlayer(args[3]))){
						...
						sender.sendMessage(main.pref + " Dodano graczowi  " + nick + " " + value + " " + main.msg.getNameWaluta1());

						}
						else if(wal == waluta.waluta2){
						sender.sendMessage(main.pref + " Dodano graczowi  "  + nick + " " + value + " " +main.msg.getNameWaluta2());

						
						}
						else if(wal == waluta.waluta3){
						sender.sendMessage(main.pref + " Dodano graczowi  " + nick + " " + value + " " + main.msg.getNameWaluta3());


						}
						
						manager.addMoney(nick, value, wal);
